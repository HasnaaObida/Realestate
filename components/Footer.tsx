    ...
    <footer className="bg-[#0f2f2a] text-gray-300">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="hover:text-yellow-500 cursor-pointer">Buy Property</li>
            <li className="hover:text-yellow-500 cursor-pointer">Rent Property</li>
            <li className="hover:text-yellow-500 cursor-pointer">Sell Property</li>
            <li className="hover:text-yellow-500 cursor-pointer">Consulting</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex rounded-lg overflow-hidden border border-gray-700">
            ...
            />
            <button className="bg-yellow-500 px-6 py-2 text-white font-semibold hover:bg-yellow-600 transition">
              Send
            </button>
          </div>
        </div>
